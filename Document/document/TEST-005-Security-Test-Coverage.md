# セキュリティテストカバレッジ (Security Test Coverage)
...
## レベル 1 - セキュリティテストスコープとスコープ外を定めている
...
## レベル 3 - セキュリティテストカバレッジを継続的に監視し、拡大している
